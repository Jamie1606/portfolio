  ...
  return (
    <footer className="flex flex-col w-full py-8 mt-12 items-center">
      <div className="gap-x-10 flex w-full justify-center items-center md:gap-x-6 mb-4">
        <motion.div initial={{ y: -30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.3, delay: 0.3 }}>
          <Link href="https://github.com/Jamie1606" target="_blank">
            <GitHubIcon width={22} height={22} fill="#181717" />
          </Link>
        </motion.div>
        <motion.div initial={{ y: -30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.3, delay: 0.6 }}>
          <Link href="https://www.linkedin.com/in/zayyartun2025" target="_blank">
            <LinkedInIcon width={22} height={22} fill="#0A66C2" />
          </Link>
        </motion.div>
        <motion.div initial={{ y: -30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.3, delay: 0.7 }}>
      ...
      <motion.div initial={{ y: -30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.3, delay: 0.9 }}>
