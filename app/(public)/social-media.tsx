  ...
  return (
    <div className="hidden fixed right-8 min-h-screen justify-center lg:flex">
      <div className="flex flex-col gap-y-8 items-center my-auto">
        <motion.div initial={{ x: 80 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1 }}>
        ...
        <motion.div initial={{ x: 80 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.2 }}>
        ...
        <motion.div initial={{ x: 80 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.4 }}>
        ...
        <motion.div initial={{ x: 80 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.6 }}>
